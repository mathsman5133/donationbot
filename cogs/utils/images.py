...
if creds.live:
    ...
    absolute_path = ""
BACKGROUND = Image.open(f"{absolute_path}assets/snowyfield.png").resize((4000, 4500))
TROPHYBOARD_BACKGROUND = Image.open(f"{absolute_path}assets/clash_cliffs.png").resize((4000, 4500))
